...
public:
    void sendProgramChange(juce::MidiBuffer& midiMessages, int programNumber) {
        midiMessages.addEvent(juce::MidiMessage::programChange(1, programNumber), 0);
        midiMessages.addEvent(juce::MidiMessage::programChange(2, programNumber), 0);
        midiMessages.addEvent(juce::MidiMessage::programChange(3, programNumber), 0);
    }
    ...
    void processHandData(juce::MidiBuffer& midiMessages,
        ...
        MusicalRangeMode rangeMode, int startOctave, int endOctave) {
        ...
        float leftX = -1.0f, leftY = -1.0f, leftZ = -1.0f, leftRoll = -1.0f;
        ...
        float rightX = -1.0f, rightY = -1.0f, rightZ = -1.0f, rightRoll = -1.0f;
        ...
        float leftGrab = leftHand.isPresent ? leftHand.grabStrength : -1.0f;
        float leftPinch = leftHand.isPresent ? leftHand.pinchStrength : -1.0f;
        float rightGrab = rightHand.isPresent ? rightHand.grabStrength : -1.0f;
        float rightPinch = rightHand.isPresent ? rightHand.pinchStrength : -1.0f;
        ...
        float leftPitchVal = getAxisValue(GestureTarget::Pitch, leftX, leftY, leftZ, leftRoll, leftGrab, leftPinch,
            leftXTarget, leftYTarget, leftZTarget, leftRollTarget, leftGrabTarget, leftPinchTarget);
        float leftTriggerVal = getAxisValue(GestureTarget::NoteTrigger, leftX, leftY, leftZ, leftRoll, leftGrab, leftPinch,
            leftXTarget, leftYTarget, leftZTarget, leftRollTarget, leftGrabTarget, leftPinchTarget);
        float leftVolumeVal = getAxisValue(GestureTarget::Volume, leftX, leftY, leftZ, leftRoll, leftGrab, leftPinch,
            leftXTarget, leftYTarget, leftZTarget, leftRollTarget, leftGrabTarget, leftPinchTarget);

        float rightPitchVal = getAxisValue(GestureTarget::Pitch, rightX, rightY, rightZ, rightRoll, rightGrab, rightPinch,
            rightXTarget, rightYTarget, rightZTarget, rightRollTarget, rightGrabTarget, rightPinchTarget);
        float rightTriggerVal = getAxisValue(GestureTarget::NoteTrigger, rightX, rightY, rightZ, rightRoll, rightGrab, rightPinch,
            rightXTarget, rightYTarget, rightZTarget, rightRollTarget, rightGrabTarget, rightPinchTarget);
        float rightVolumeVal = getAxisValue(GestureTarget::Volume, rightX, rightY, rightZ, rightRoll, rightGrab, rightPinch,
            rightXTarget, rightYTarget, rightZTarget, rightRollTarget, rightGrabTarget, rightPinchTarget);

        float globalVolumeVal = std::max(leftVolumeVal, rightVolumeVal);

        handleNoteLogic(midiMessages, leftPitchVal, leftTriggerVal, globalVolumeVal, rootNote, scaleType, leftChannel, leftNoteState,
            invertNoteTrigger, rangeMode, octaveRange, startOctave, endOctave);

        handleNoteLogic(midiMessages, rightPitchVal, rightTriggerVal, globalVolumeVal, rootNote, scaleType, rightChannel, rightNoteState,
            invertNoteTrigger, rangeMode, octaveRange, startOctave, endOctave);
        ...
        processHandCCs(leftHand, leftChannel, leftX, leftY, leftZ, leftRoll, leftGrab, leftPinch,
            leftXTarget, leftYTarget, leftZTarget, leftRollTarget, leftGrabTarget, leftPinchTarget,
            lThumb, lIndex, lMiddle, lRing, lPinky);

        processHandCCs(rightHand, rightChannel, rightX, rightY, rightZ, rightRoll, rightGrab, rightPinch,
            rightXTarget, rightYTarget, rightZTarget, rightRollTarget, rightGrabTarget, rightPinchTarget,
